...
public class UserService {
    ...
    public User updateProfile (UserProfileDTO userProfileDTO) throws PasswordException {
        ...
        if(!userProfileDTO.getPassword().isEmpty()) {
            System.out.println("getConfirmPassword "+userProfileDTO.getConfirmPassword());
            if(userProfileDTO.getConfirmPassword() == null) {
